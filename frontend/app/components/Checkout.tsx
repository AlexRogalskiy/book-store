...
import { useAddOrderMutation } from "@/app/store/reducers/orders/ordersApi";
...
const Checkout = () => {
    ...
    if (!currentUser) return <div>Please login to place an order</div>;
                                    ...
                                    <div className="grid gap-4 gap-y-2 text-sm grid-cols-1 md:grid-cols-5">
                                        ...
                                        <div className="md:col-span-5 mt-3">
                                            <div className="inline-flex items-center">
                                                ...
                                                <label htmlFor="billing_same" className="ml-2 ">I am agree to the <Link
                                                    className='underline underline-offset-2 text-blue-600' href="/">Terms &
                                                    Conditions</Link> and <Link
                                                    className='underline underline-offset-2 text-blue-600' href="/">Shopping
                                                    Policy.</Link>
                                                </label>
                                            </div>
                                        </div>
                                        ...
                                        <div className="md:col-span-5 text-right">
                                            <div className="inline-flex items-end">
                                                <button
                                                    disabled={!isChecked}
                                                    className="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded">Place
                                                    an Order
                                                </button>
                                            </div>
                                        </div>
