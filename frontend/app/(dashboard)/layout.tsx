                        ...
                        <header className="flex items-center h-20 px-6 sm:px-10 bg-white">
                            ...
                            <div className="flex flex-shrink-0 items-center ml-auto">
                                <button
                                    ...
                                    <span
                                        className="h-12 w-12 ml-2 sm:ml-3 mr-2 bg-gray-100 rounded-full overflow-hidden">
                                      <img src="https://randomuser.me/api/portraits/men/1.jpg" alt="user profile photo"
                                ...
                                <div className="border-l pl-3 ml-3 space-x-1">
                                    <button
                                        ...
                                        <span
                                            className="absolute top-0 right-0 h-2 w-2 mt-1 mr-2 bg-red-500 rounded-full"></span>
                                        <span
                                            className="absolute top-0 right-0 h-2 w-2 mt-1 mr-2 bg-red-500 rounded-full animate-ping"></span>
                                        <svg aria-hidden="true" fill="none" viewBox="0 0 24 24" stroke="currentColor"
                                             className="h-6 w-6">
                                            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2"
